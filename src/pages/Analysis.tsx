...
Sport Type: ${displayData.sportType}
${videoFileName ? `Video File: ${videoFileName}` : ''}

SCORES
------
Total Score: ${displayData.totalScore.toFixed(1)}
Difficulty: ${displayData.difficulty.toFixed(1)}
Execution: ${displayData.execution.toFixed(1)}

BIOMECHANICAL METRICS
---------------------
Knee Angle: ${displayData.biomechanics.kneeAngle}
Form Score: ${displayData.biomechanics.formScore}
Air Time: ${displayData.biomechanics.airTime}
Hip Extension: ${displayData.biomechanics.hipExtension}

DETECTED ISSUES
---------------
${displayData.deductions.map((d: any) => `• ${d.type} (${d.points}) - ${d.description}${d.timestamp ? ` @ ${d.timestamp}` : ''}`).join('\n')}

PERFORMANCE HIGHLIGHTS
----------------------
${displayData.strengths.map((s: string) => `• ${s}`).join('\n')}

---
Generated by Olympic Edge AI Performance Analysis
    `.trim();
    ...
    a.href = url;
    a.download = `routine-analysis-${videoFileName || 'report'}.doc`;
  ...
  const handleShare = () => {
    const shareText = `Check out my gymnastics routine analysis! Score: ${displayData.totalScore.toFixed(1)} 🏅`;
    const shareUrl = window.location.href;

    if (navigator.share) {
      // Use native share if available
      navigator.share({
        title: 'Olympic Edge - Routine Analysis',
        text: shareText,
        url: shareUrl,
      }).catch(() => {
